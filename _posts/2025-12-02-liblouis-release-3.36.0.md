...
For a detailed list of all the changes refer to [the list of closed issues](https://github.com/liblouis/liblouis/milestone/46?closed=1).
...
-   There is a new table for [English Grade 3](http://www.grade3braille.com) thanks to Bue Vester-Andersen.
...
-   Update the Slovakian 6-dot literary table to be in line with the latest Slovak braille standards thanks to Peter Vágner and other members of the [Braille Authority of Slovakia](https://www.skn.sk/en/the-braille-authority-of-slovakia).
